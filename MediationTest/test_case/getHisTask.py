...
gethistask_xls = getData.get_xls("mediationCase.xlsx", "gethistask")
rc = readConfig.ReadConfig("config.ini")
http = Http()



@paramunittest.parametrized(*gethistask_xls)
class GetHisTask(unittest.TestCase):
    ...
    def testGetCurTask(self):
        ...
        """
        # set url
        self.url = rc.get_interface_url("getHisTask")
